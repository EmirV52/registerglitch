...
exports.run = async (client, message, args) => {
    ...
    if(!message.member.roles.cache.some(r => ["778979092246691891"].includes(r.id)) && (!message.member.hasPermission("ADMINISTRATOR")))
...
.setFooter(`Platon Registration`) // evet bilerek kaldırmadım ayriyetten sıfırdan yazdım :)
