...
client.on("guildMemberAdd", member => {
  member.roles.add('778979107168976916'); // UNREGİSTER ROLÜNÜN İDSİNİ GİRİN
...
client.on("guildMemberAdd", member => {  
    const kanal = member.guild.channels.cache.find(r => r.id === "778979166892589066");
    const register = "<@&778979092246691891>"
...
client.on("userUpdate", async (oldUser, newUser) => {
  ...
  const tag = '✧'
  const sunucu = '766736174592163842'
  const kanal = '778979190501802025'
  const rol = '778979105776336906'
